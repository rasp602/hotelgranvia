...
$con = mysqli_connect('srv1056.hstgr.io','u854084565_rasp602','Rodri2410$','u854084565_hoteleria');
// Check connection
...
$Insertar=mysqli_query($con,"INSERT INTO `entradat`(idTrabajador,Fecha,fechaEntradaT,horaEntrada,fechaSalida,horaSalida,horasTrabajadas,horasExtras,validacion) VALUES ('$idTrabajador','$fechaFija','$fechaDefecto','$horaCero','$fechaDefecto','$salidaDefecto','$horasTrabajadasDefecto','$horasExtrasDefecto','$validacion')");
...
$mañana=date("Y-m-d",strtotime($fecha."+ 1 days")); 
$subject = "Registro de Trabajadores";// El valor entre corchetes son los atributos name del formulario html
