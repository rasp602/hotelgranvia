...
<script src="hospedaje/vista/script.js"></script>
...
<script src="js/select2.full.min.js"></script> 
  ...
  <?php if (isset($_GET["repetido"])) echo '<div class="alert alert-warning" role="alert">La persona que intenta ingresar ya se encuentra registrada y con una habitacion ocupada</div>';?> 
    ...
    <div class="row">
      <div class="col-md-12">
      <label for="personas">Buscar y seleccionar una persona:</label>
    <select id="personas" name="personas" style="width: 300px;"></select>
   <h4>Persona</h4>
              ...
              <div class="col-md-12" align="left">
               ...
               <div class="row">     
                ...
                <div class="input-group mb-3">
                  <input type="text" id="desde" name="desde" placeholder="desde" value="<?php echo date("d-m-Y");?>" class="form-control">
                  ...
                  <div class="row">     
                    ...
                    <h4>Hasta</h4>         
                <div class="input-group mb-3">
                  <input type="text" id="hasta" name="hasta" placeholder="hasta" value="<?php echo date("d-m-Y");?>" class="form-control">
                  <div class="input-group-addon">
                    <span class="glyphicon glyphicon-th"></span>
                  </div>
                </div>
