...
class Persona
{
	...
	public function Registrar(Persona $data)
	{
		...
		$sql = "INSERT INTO persona (idPersona, rutPersona, nombresPersona, apellidoPersona1, apellidoPersona2, fechaCreado, fotoPersona, qrPersona,genero,horaCreado,card,idEmpresa) 
		        VALUES (?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?)";
