...
if ($tipoComida!="") {
    $where="where comida.tipoComida LIKE'%".$tipoComida."%'";

}

if ($idPersona!="") {
    $where="where persona.idPersona LIKE'%".$idPersona."%'";
...
for ($i=1; $i<=$numfilas; $i++)
        {             
              $espacio = "";
                ...
                $pdf->Row(array($i,$fila['fechaComida'],$fila['horaComida'],$fila['tipoComida'],$fila['nombresPersona']." ".$fila['apellidoPersona1'],$fila['nombreEmpresa'],$espacio));
