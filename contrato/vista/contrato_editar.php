...
<div class="">
  ...
  <?php if (isset($_GET["repetido"])) echo '<div class="alert alert-warning" role="alert">El contrato que intenta ingresar ya se encuentra registrado...</div>';?> 
        <div class="col-md-2"></div>
        <div class="col-md-8">

                        <h2 align="center" class="titulos">Actualizar Contrato</h2>

    <form id="form1" action="?c=contrato&a=Guardar" name="form1" method="post" enctype="multipart/form-data">
      <input type="hidden" class="form-control" id="idContrato" name="idContrato" value="<?php echo $vte->idContrato;?>"> 

                  <div class="row">     
                    <div class="col-md-12">
                    <h4>Nombre Contrato</h4>
                    <input type="text" class="form-control" id="nombreContrato" name="nombreContrato" value="<?php echo $vte->nombreContrato;?>" onkeypress="">
                    </div>              
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <h4>Empresa</h4>
                      <select name="idEmpresa" id="idEmpresa" class="form-control  input-sm" required=""> 
