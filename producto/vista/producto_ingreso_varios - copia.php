    ...
    <div class="stock-shell">
        ...
        <div class="stock-card">
            <div class="stock-header">
                ...
                <p>Escanea el código del producto, ingresa la cantidad y actualiza el inventario de forma rápida.</p>
            </div>
    ...
    $("#productBarcode").on('keypress', function(e) {
        ...
        timer = setTimeout(function() {
            if (inputBuffer.length > 0) {
                $("#productBarcode").val(inputBuffer);
                $("#barcodeScanned").val(inputBuffer);

                $.ajax({
                    url: 'consultar_producto.php',
                    type: 'POST',
                    data: { 
                        codigoBarra: inputBuffer
                    },
                    dataType: 'json',
        ...
        }, 120); // menor tiempo para mantenerlo ágil
    });
