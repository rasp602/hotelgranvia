    ...
    <div class="stock-shell">
        ...
        <div class="stock-card">
            <div class="stock-header">
                ...
                <p>Escanea el código y actualiza el inventario de forma rápida.</p>
            </div>
                ...
                <div class="panel-box">
                    ...
                    <div id="ultimoProductoBox" class="ultimo-producto-box">
                        <div class="titulo-modulo" style="font-size:20px; margin-bottom:15px;">
                            <i class="bi bi-box-seam"></i> Último Producto Agregado
                        </div>
                    ...
                    <div class="text-center" style="margin-top:18px;">
                        <a href="?c=producto&a=menuProducto" class="btn btn-outline-primary">
