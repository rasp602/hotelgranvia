...
if ($idMaquina==112) {
    ...
    $where="where actividad.idMaquina='".$idMaquina."' AND usuario.id_user = '".$usuario."'";
    /*echo "if maquina"; */
}
		...
		<table class="table table-condensed table-striped table-bordered table-hover" id="tabla">
            ...
            ?>
				<tr>
                    ...
                    <?php if ($row['statusA']=="INVALIDA"): ?>
                      <a href="" class=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark-x-fill" viewBox="0 0 16 16">
                      <path fill-rule="evenodd" d="M2 15.5V2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.74.439L8 13.069l-5.26 2.87A.5.5 0 0 1 2 15.5zM6.854 5.146a.5.5 0 1 0-.708.708L7.293 7 6.146 8.146a.5.5 0 1 0 .708.708L8 7.707l1.146 1.147a.5.5 0 1 0 .708-.708L8.707 7l1.147-1.146a.5.5 0 0 0-.708-.708L8 6.293 6.854 5.146z"/></svg></a>
                    <?php endif ?>
                  <?php if ($row['statusA']=="VALIDA"): ?>
