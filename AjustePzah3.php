...
require('bd/conexionLocalh3.php');//h2
...
//ELIMINAR REGISTROS DUPLICADOS EN LA TABLA COMIDA DEL HOTEL H3
$ElimiarDuplicadosH3=mysqli_query($con,"DELETE c1
FROM comida c1
INNER JOIN comida c2 ON 
  ...
  echo '<div class="alert alert-success"><strong>Success!</strong> Registro duplicados eliminados HOTEL H3...!</div>';
