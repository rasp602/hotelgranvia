...
function Header()
{
  ...
  $this->Cell(50, 8, '', 0);
  $this->Cell(100, 8, 'CONTROL DE CENAS DE LOS HOTELES', 0);
  $this->Ln(5);
  $this->Cell(150, 10, ' ', 0);
  $this->Ln(5);
...
CROSS JOIN hotel
LEFT JOIN comida ON calendar.fechaComida = comida.fechaComida
AND comida.tipoComida LIKE '%".$tipoComida."%' and hotel.idHotel = 3
LEFT JOIN hospedaje ON comida.idHospedaje = hospedaje.idHospedaje
AND hospedaje.idHotel = hotel.idHotel
GROUP BY calendar.fechaComida
ORDER BY calendar.fechaComida"); // Agrega la consulta para obtener la información de la segunda columna
...
CROSS JOIN hotel
LEFT JOIN comida ON calendar.fechaComida = comida.fechaComida
AND comida.tipoComida LIKE '%".$tipoComida."%' and hotel.idHotel = 4
LEFT JOIN hospedaje ON comida.idHospedaje = hospedaje.idHospedaje
AND hospedaje.idHotel = hotel.idHotel
GROUP BY calendar.fechaComida
ORDER BY calendar.fechaComida"); // Agrega la consulta para obtener la información de la segunda columna
...
$total= $fila1['desayunos']+$fila1extra['desayunosextra']+$fila2['desayunos']+$fila2extra['desayunosextra']+$fila3['desayunos']+$fila3extra['desayunosextra']+$fila4['desayunos']+$fila4extra['desayunosextra']+$fila5['desayunos'];
    ...
    $pdf->Row(array($fila1['fechaComida'],$fila1['desayunos']+$fila1extra['desayunosextra'],$fila2['desayunos']+$fila2extra['desayunosextra'],$fila3['desayunos']+$fila3extra['desayunosextra'],$fila4['desayunos']+$fila4extra['desayunosextra'],$fila5['desayunos'],$total));
