...
class ComidaEspecial
{
	...
	public function ListarComida()
	{
		try
		{
			...
			$stm = $this->pdo->prepare("SELECT * FROM comidaespecial ORDER BY comidaespecial.idComidaEspecial");
			$stm->execute();
...
public function Actualizar($data)
	...
	public function Eliminar($idComidaEspecial)
	{
		try 
		{
			$stm = $this->pdo->prepare("DELETE FROM comida WHERE idComidaEspecial = ?");			          

			$stm->execute(array($idComidaEspecial));
		} catch (Exception $e) 
		{
			die($e->getMessage());
		}
