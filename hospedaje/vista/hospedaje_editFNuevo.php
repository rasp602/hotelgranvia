     ...
     <div class="container-fluid">
        <div class="col-md-4">
              ...
              <path d="m8 3.293 4.712 4.712A4.5 4.5 0 0 0 8.758 15H3.5A1.5 1.5 0 0 1 2 13.5V9.293l6-6Z"/>
               ...
               <form id="form1" action="?c=hospedaje&a=GuardarQr" name="form1" method="post" enctype="multipart/form-data">
               ...
               <input type="hidden" class="form-control" id="estado" name="estado" value="A">  
                 <input type="hidden" class="form-control" id="idUsuario" name="idUsuario" value="<?php echo $usuario->id_user;?> ">  
                    ...
                    <div class="row">     
                        ...
                        <select name="idHotel" id="idHotel" class="form-control  input-sm" style="visibility:hidden">
