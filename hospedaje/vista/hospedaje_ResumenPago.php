...
<script src="hospedaje/js/ajaxPago.js"></script>
...
<h4>Empresa</h4>
 ...
 <?php $fecha=date('Y-m-d') ?>
          ...
          <div class="input-group">
               <input class="form-control" id="dia_ini" name="dia_ini"  type="date" value="<?php echo $fecha; ?>"  autocomplete="off" required/>
        ...
        <div class="col-md-2">
            <h4>Hasta</h4>
          <div class="input-group">
               <input class="form-control" id="dia_fin" name="dia_fin"  type="date" value="<?php echo $fecha; ?>"  autocomplete="off" required/>
      ...
      <div class="col-md-1">
        <div class="col-md-6">
         <a href="javascript:resumenPago();"  data-toggle="tooltip" title="descargar Hospedajes"><img src="img/pdf.png" width="50px" height="50px"><p>R.Pago</p></a>
        </div>

      <div class="col-md-6">
         <a href="javascript:resumenPagoExcel();"  data-toggle="tooltip" title="descargar Hospedajes"><img src="img/excel.png" width="50px" height="50px"><p>R.Pago</p></a>
      </div>
    </div>
