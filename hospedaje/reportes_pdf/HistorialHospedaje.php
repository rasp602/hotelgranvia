...
for ($i=1; $i<=$numfilas; $i++)
       ...
       $pdf->SetWidths(array(12,40,40,40,60, 30, 20, 30, 30,30));
                ...
                $pdf->Row(array($i,$fila['nombreHotel'],$fila['nombreEmpresa'],$fila['rutPersona'],$fila['nombresPersona']." ".$fila['apellidoPersona1'] ,$fila['nHabitacion'],$fila['nCama'],$newDate1,$newDate2,$espacio));
