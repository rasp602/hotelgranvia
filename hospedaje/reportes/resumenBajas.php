...
include '../../bd/conexionLocal.php'; //incluir el archivo de conexion
	...
	if($action == 'ajax'){
		include 'pagination_bajas.php'; //incluir el archivo de paginación
...
$fechaActual=date("Y-m-d");
 ...
 if ($idUsuario=="44") {
$where="WHERE hospedaje.estado = 'I' and hospedaje.fechaDespedida BETWEEN '$fechaActual' and '$fechaActual' and hospedaje.idHotel='1'";
}

if ($idUsuario=="45") {
$where="WHERE hospedaje.estado = 'I' and hospedaje.fechaDespedida BETWEEN '$fechaActual'  and '$fechaActual' and hospedaje.idHotel='2'";
}

if ($idUsuario=="46") {
$where="WHERE hospedaje.estado = 'I' and hospedaje.fechaDespedida BETWEEN '$fechaActual'  and '$fechaActual' and hospedaje.idHotel='3'";
}

if ($idUsuario=="47") {
$where="WHERE hospedaje.estado = 'I' and hospedaje.fechaDespedida BETWEEN '$fechaActual'  and '$fechaActual' and hospedaje.idHotel='4'";
}
if ($idUsuario=="48") {
$where="WHERE hospedaje.estado = 'I' and hospedaje.fechaDespedida BETWEEN '$fechaActual'  and '$fechaActual' and hospedaje.idHotel='5'";
}
...
$query = mysqli_query($con,"SELECT 
        ...
        $where 
        ORDER BY hospedaje.horaDespedida desc
		...
		<table class="table table-condensed table-striped table-bordered table-hover" id="tabla">
            ...
            <td class="contenidoTabla"><?php echo utf8_encode($row['horaDespedida']);?></td>
