        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <a href="#" class="nav-link active">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="?c=hotel&a=menuHotel" class="nav-link">              
                  <i class='fas fa-hotel' style='font-size:24px'></i>
                  <p>Hoteles</p>
                </a>
              </li> 
              <li class="nav-item">
                <a href="?c=empresa&a=menuEmpresa" class="nav-link">
                  <i class='fas fa-briefcase' style='font-size:24px'></i>
                  <p>Empresas</p>
                </a>
              </li>  
              <li class="nav-item">
                <a href="?c=contrato&a=menuContrato" class="nav-link">
                  <i class='fa-solid fa-handshake' style='font-size:24px'></i> 
                  <p>Contratos</p>
              ...
              <li class="nav-item">
                <a href="?c=hospedaje&a=menuHospedajeDiario" class="nav-link">
             ...
             <li class="nav-item">
              ...
              <li class="nav-item">
  <a href="#" class="nav-link" onclick="verificarClave()">
  <i class="bi bi-exclamation-square-fill" style='font-size:24px'></i>
...
<script>
  function verificarClave() {
    const claveCorrecta = "rasp071989"; // Reemplaza con la clave que desees
    const claveIngresada = prompt("Por favor, ingresa la clave:");

    if (claveIngresada === claveCorrecta) {
      window.location.href = "https://www.hotelgranvia.net/getHospAct.php";
    } else {
      alert("Clave incorrecta. Acceso denegado.");
          ...
          <li class="nav-item menu-open">            
            ...
            <li class="nav-item">
                <a href="?c=comida&a=indicadores" class="nav-link">
            ...
            <li class="nav-item">
                <a href="?c=comida&a=menuComida" class="nav-link">
              ...
              <li class="nav-item">
                <a href="?c=comidaextra&a=menuComidaExtra" class="nav-link">
                 <i class='fas fa-pizza-slice' style='font-size:24px'></i>
                  <p>Comidas Extras</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="?c=comidaservida&a=menuComidaServida" class="nav-link">
                 <i class='fas fa-pizza-slice' style='font-size:24px'></i>
                  <p>Comidas Servidas H5</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="?c=comidaespecial&a=menuComidaEspecial" class="nav-link">
                 <i class='fas fa-pizza-slice' style='font-size:24px'></i>
                  <p>Comidas Especiales</p>
                </a>
              </li>
         ...
         <!--
              ...
              <li class="nav-item">
                <a href="?c=ingreso&a=menuIngreso" class="nav-link">
                  <i class='fas fa-retweet' style='font-size:24px'></i>
                  <p>E/S Trabajadores</p>
                </a>
              </li>
 
              <li class="nav-item">
                <a href="?c=trabajador&a=menuTrabajador" class="nav-link">
