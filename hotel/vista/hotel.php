...
<script src="hotel/js/ajaxH.js"></script>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-auto h5">
                 <a href="?c=hotel&a=Crud"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-building-add" viewBox="0 0 16 16">
                ...
                <div class="col-md-12">
                    <table class="table table-condensed table-striped table-bordered table-hover">
                        <thead class="bg-primary" align="center">
                            ...
                            <th class="sort asc h4">Capacidad</th>
    ...
    <script>
        ...
        function getData() {
            ...
            let url = "hotel/vista/loadHotel.php"
