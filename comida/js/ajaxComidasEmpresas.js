function reportePDF1(){
    ...
    //window.open('comida/reportes_pdf/list_comida.php?tipoComida='+tipoComida+'&idPersona='+idPersona+'&desde='+desde+'&hasta='+hasta+'&idEmpresa='+idEmpresa+'&idHotel='+idHotel);
     window.open('comida/reportes_pdf/list_comida_empresa.php?tipoComida='+tipoComida+'&idPersona='+idPersona+'&desde='+desde+'&hasta='+hasta+'&idHotel='+idHotel+'&idEmpresa='+idEmpresa);
}
...
function reportePDF2() {
    ...
    if (desde === '' || hasta === '') {
        ...
        window.open('comida/reportes_pdf/control_desayuno.php?desde=' + desde + '&hasta=' + hasta);
    }
}
...
function reportePDF3(){
    ...
    if (desde === '' || hasta === '') {
        ...
        window.open('comida/reportes_pdf/control_almuerzo.php?desde=' + desde + '&hasta=' + hasta);
    }
}
...
function reportePDF4(){
    ...
    if (desde === '' || hasta === '') {
        ...
        window.open('comida/reportes_pdf/control_cena.php?desde=' + desde + '&hasta=' + hasta);
    }
}
    ...
    function load10(page){
        ...
        $.ajax({
            type: "POST",
            url:'comida/reportes/list_comida_empresas.php',
            data: parametros,         
