  ...
  toastr.info('Bienvenido')
    ...
    <div class="row"> 
        <div class="col-md-12" align="center">
          <h2>Registrar Comida extra</h2>
        </div>
    </div>

 <div class="col-md-5"></div>
              <div class="col-md-2" align="center">
                  <form id="form1" action="?c=comidaextra&a=Guardar" name="form1" method="post" enctype="multipart/form-data">
                    <input type="hidden" class="form-control" id="idComidaExtra" name="idComidaExtra" value="<?php echo $vte->idComidaExtra;?>" placeholder=""> 
           
                    <div class="row">     
                      <div class="col-md-12">
                        <h4>Nombre de Persona: </h4>
                           <input type="text" class="form-control" name="persona" id="persona" placeholder="persona">
                        </div>             
                    </div>
              ...
              <select  name="tipoComida" id="tipoComida" class="form-control  input-sm">
                                <option value="Desayuno">VALE ALMUERZO/CENA</option>
