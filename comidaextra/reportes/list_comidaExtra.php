            ...
            <?php
                ...
                <td class=""><?php echo utf8_encode($row['nombreHotel']);?></td>
                       ...
                       <td class=""><?php echo utf8_encode($row['tipoComida']);?></td>
                        ...
                        <td><a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?c=comidaextra&a=Eliminar&idComidaExtra=<?php echo $row['idComidaExtra']?>" class="glyphicon glyphicon-remove"></a></td>
