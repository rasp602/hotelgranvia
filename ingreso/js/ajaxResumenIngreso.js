  function reportePDF1(){
    ...
    window.open('ingreso/reportes_pdf/resumenIngreso.php?nombreTrabajador='+nombreTrabajador+'&idHotel='+idHotel+'&desde='+desde+'&hasta='+hasta);
}
    ...
    function load11(page){
        ...
        $.ajax({
            url:'ingreso/reportes/resumenIngreso.php',
            data: parametros,      
