...
if ($nombreTrabajador!="") {
    $where="where trabajador.estado LIKE 'A' and trabajador.nombreTrabajador LIKE'%".$nombreTrabajador."%' OR trabajador.apellidoTrabajador1 LIKE'%".$nombreTrabajador."%' ";
      ...
      $contarTrabajadas = mysqli_query($con,"SELECT 
        ...
        <table class="table table-condensed table-striped table-bordered table-hover" id="tabla">
                            ...
                            <thead>
                                 ...
                                 <th class="contenidoTabla">Condición</th>
                                 <th class="contenidoTabla">H.Trabajadas</th> 
                                 <th class="contenidoTabla">H.Extras</th>
                                 <th class="contenidoTabla">Validación</th>                                                                                                                 
                                </tr>
                            </thead>
            <tbody>
                <br>
            <?php
                ...
                <tr>      
                       ...
                       <td class="contenidoTabla"><?php echo utf8_encode($row['nombreHotel']);?></td>
                         <td class="contenidoResultado"><?php echo utf8_encode($row['labor']);?></td>
                    <td class="contenidoTabla">
                      ...
                      <?php endif ?>                                
                       ...
                       <td class="contenidoTabla">
                        ...
                        <a href="?c=trabajador&a=condicion&idTrabajador=<?php echo $row['idTrabajador']?>">
                          Operativo</a>
                        </svg>
                      <?php endif ?>
                            <?php if ($row['condicion']=="2"): ?>

                        <a href="?c=trabajador&a=condicion&idTrabajador=<?php echo $row['idTrabajador']?>">
                          Vacaciones</a>
                        </svg>
                      <?php endif ?>
                        <?php if ($row['condicion']=="3"): ?>

                        <a href="?c=trabajador&a=condicion&idTrabajador=<?php echo $row['idTrabajador']?>">
                          Descanso</a>
                        </svg>
                      <?php endif ?>
                      <?php if ($row['condicion']=="4"): ?>
                        <a href="?c=trabajador&a=condicion&idTrabajador=<?php echo $row['idTrabajador']?>">
                          Licencia</a>
                        </svg>
                      <?php endif ?>
                       ...
                       <td class="contenidoTabla"><?php echo utf8_encode($row['horasTrabajadas']);?></td>
                       <td class="contenidoTabla"><?php echo utf8_encode($row['horasExtras']);?></td>

                                           <td class="contenidoTabla">
                      <?php if ($row['validacion']=="0"): ?>

                        <a href="?c=ingreso&a=Crud2&idEntradaT=<?php echo $row['idEntradaT']?>">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle" viewBox="0 0 16 16">
                          <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                          <path d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z"/></a>
                        </svg>
                      <?php endif ?>
