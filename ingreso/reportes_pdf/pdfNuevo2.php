    ...
    {   
        while($row = mysqli_fetch_assoc($result)) {
            ...
            if($row3 = mysqli_fetch_assoc($result3)){
                $fecha_desc_ini = $row3['fecha_inicio'];
                $fecha_desc_fin = $row3['fecha_final'];
            }            
            ...
            if($result2 = mysqli_query($conn, $sql2))
            {
                ...
                while($row2 = mysqli_fetch_assoc($result2)) {
                    for($j = $jaux; $j <= $num_days; $j++,$jaux++){                    
                        ...
                        }else if($fecha_desc_ini != ''){
                            if($j == $fecha_desc_ini){
                                //echo ($fecha_desc_ini . ' - ' . $j . '<br>');
                                for($h = $fecha_desc_ini; $h<=$fecha_desc_fin; $h++){ 
                                    //echo ($fecha_desc_ini . ' ---i-- ' . $fecha_desc_fin . ' ---i-- ' . $j . '<br>');
