<script src="ingreso/js/ajaxIngresoFiscalizador.js"></script>
<script src="ingreso/js/ajaxHospedaje.js"></script>
<?php
...
<h6>Escanea tu codigo QR para registrar tu Entrada ó Salida</h6>
...
function showHint(str) {
  ...
  if (str.length == 0) {
    ...
    xmlhttp.open("GET", "gethintEntradaTrabajador.php?q=" + str, true);
    xmlhttp.send();
    location.reload(500);
